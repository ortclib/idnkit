...
# Convert U+0041 (A) to U+0061 (a) when the current language is Japanese.
#
#             api: decodename
...
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'ABC' > output.txt
