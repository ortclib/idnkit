...
# In a 'language-local' line in the configuration file, use "JPN"
# (ISO639-2 code) to specify Japanese.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: language ja
#            conf: map language-local
#            conf: language-local JPN @LOCALMAP_FILE1@
#       localmap1: 0041; 0061;
#            from: ABC
...
echo 'language-local JPN localmap1' >> idn2.conf
