...
# It defines 'language-local' for Japaese and English.
# language-local conversion for English must be chosen.
#
#             api: encodename
...
#            conf: language-local en  @LOCALMAP_FILE2@
#       localmap1: 0041; 0061;
#       localmap2: 0042; 0062;
#            from: ABC
...
echo 'language-local en  localmap2' >> idn2.conf
