...
# The input name contains no prohibited code point, but a contexto
# codecpoint U+00B7, instead.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: 0123456789012345678901234567890123456789012345678901234567890123
...
echo 'from: 0123456789012345678901234567890123456789012345678901234567890123' >> expect.txt
echo 'result: label length check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -idnconv -lencheck -- '0123456789012345678901234567890123456789012345678901234567890123' > output.txt
