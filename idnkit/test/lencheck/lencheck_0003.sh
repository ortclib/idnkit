...
# The input name is a Punycode string with 63 characters.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: 012345678901234567890123456789012345678901234567890123456789012
...
echo 'from: 012345678901234567890123456789012345678901234567890123456789012' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: 012345678901234567890123456789012345678901234567890123456789012' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -idnconv -lencheck -- '012345678901234567890123456789012345678901234567890123456789012' > output.txt
