...
#
# Bidicheck test.
# Check the bidi rule 4.
# The input name is U+05D0 U+0600 U+0030 U+05D0 (bidiclass: R EN AN R).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{5d0}0\u{600}\u{5d0}
...
echo 'from: \u{5d0}0\u{600}\u{5d0}' >> expect.txt
echo 'result: Bidi check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}0\u{600}\u{5d0}' > output.txt
