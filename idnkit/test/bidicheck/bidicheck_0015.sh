...
# The input name is just U+070F (bidiclass: BN).
#
#             api: encodename
...
echo 'from: \u{1d173}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{1d173}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{1d173}' > output.txt
