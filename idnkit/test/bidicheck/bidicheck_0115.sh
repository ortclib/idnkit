...
# The input name is U+0041 U+1680 U+0030 "." U+05D0
# (bidiclass: L WS EN . R).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: A\u{1680}0.\u{5d0}
...
echo 'from: A\u{1680}0.\u{5d0}' >> expect.txt
echo 'result: Bidi check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- 'A\u{1680}0.\u{5d0}' > output.txt
