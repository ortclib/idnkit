...
# The input name is U+0030 U+0061 + "." + U+05D0 (bidiclass: EN L . R).
#
#             api: encodename
...
echo 'from: 0a.xn--4db' >> expect.txt
echo 'result: Bidi check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-lookup -- '0a.xn--4db' > output.txt
