...
# The input name is U+05D0 U+001F U+0627 (bidiclass: R S AL).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{5d0}\u{1f}\u{627}
...
echo 'from: \u{5d0}\u{1f}\u{627}' >> expect.txt
echo 'result: Bidi check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}\u{1f}\u{627}' > output.txt
