...
# The input name is U+05D0 U+070F U+0300 (bidiclass: R BN NSM).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{5d0}\u{1d173}\u{300}
...
echo 'from: \u{5d0}\u{1d173}\u{300}' >> expect.txt
echo 'result: Bidi check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}\u{1d173}\u{300}' > output.txt
