...
# The input name is U+0041 U+070F U+0030 "." U+05D0
# (bidiclass: L BN EN . R).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: A\u{1d173}0.\u{5d0}
#         actions: IDN_UNICODECONV IDN_BIDICHECK IDN_LOCALCONV
#          result: success
#              to: A\u{1d173}0.\u{5d0}
...
echo 'from: A\u{1d173}0.\u{5d0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: A\u{1d173}0.\u{5d0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- 'A\u{1d173}0.\u{5d0}' > output.txt
