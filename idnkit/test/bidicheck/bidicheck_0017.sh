...
# The input name is just U+001F (bidiclass: S).
#
#             api: encodename
...
echo 'from: \u{1f}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{1f}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{1f}' > output.txt
