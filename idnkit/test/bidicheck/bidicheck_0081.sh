...
# The input name is U+05D0 U+0600 (bidiclass: R AN).
#
#             api: encodename
...
echo 'from: \u{5d0}\u{600}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{5d0}\u{600}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}\u{600}' > output.txt
