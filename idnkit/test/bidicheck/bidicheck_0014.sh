...
# The input name is just U+0300 (bidiclass: NSM).
#
#             api: encodename
...
echo 'to: \u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{300}' > output.txt
