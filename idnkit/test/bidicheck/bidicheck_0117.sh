...
# The input name is U+0041 U+0041 "." U+05D0
# (bidiclass: L L . R).
#
#             api: encodename
...
echo 'from: AA.\u{5d0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: AA.\u{5d0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- 'AA.\u{5d0}' > output.txt
