...
# The input name is just U+202B (bidiclass: RLE).
#
#             api: encodename
...
echo 'from: \u{202b}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{202b}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{202b}' > output.txt
