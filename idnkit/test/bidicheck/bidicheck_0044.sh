...
#
# Bidicheck test.
# Check the bidi rule 1.
# The input name is U+0627 + "." + U+05D0 (bidiclass: AL . R).
#
#             api: encodename
...
echo 'from: \u{627}.\u{5d0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{627}.\u{5d0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{627}.\u{5d0}' > output.txt
