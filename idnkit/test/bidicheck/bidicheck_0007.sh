...
# The input name is just U+202E (bidiclass: RLO).
#
#             api: encodename
...
echo 'from: \u{202e}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{202e}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{202e}' > output.txt
