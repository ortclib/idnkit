...
# The input name is U+05D0 U+070F (bidiclass: R BN).
#
#             api: encodename
...
echo 'from: \u{5d0}\u{1d173}' >> expect.txt
echo 'result: Bidi check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}\u{1d173}' > output.txt
