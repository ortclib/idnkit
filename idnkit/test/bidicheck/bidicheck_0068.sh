...
# The input name is U+05D0 U+0600 U+0627 (bidiclass: R AN AL).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{5d0}\u{600}\u{627}
#         actions: IDN_UNICODECONV IDN_BIDICHECK IDN_LOCALCONV
#          result: success
#              to: \u{5d0}\u{600}\u{627}
...
echo 'from: \u{5d0}\u{600}\u{627}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{5d0}\u{600}\u{627}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}\u{600}\u{627}' > output.txt
