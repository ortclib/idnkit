...
# The input name is U+05D0 U+0627 U+0300 (bidiclass: R AL NSM).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{5d0}\u{627}\u{300}
#         actions: IDN_UNICODECONV IDN_BIDICHECK IDN_LOCALCONV
#          result: success
#              to: \u{5d0}\u{627}\u{300}
...
echo 'from: \u{5d0}\u{627}\u{300}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{5d0}\u{627}\u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}\u{627}\u{300}' > output.txt
