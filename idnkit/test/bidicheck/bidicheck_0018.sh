...
# The input name is just U+1680 (bidiclass: WS).
#
#             api: encodename
...
echo 'from: \u{1680}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{1680}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{1680}' > output.txt
