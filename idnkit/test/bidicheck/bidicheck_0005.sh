...
#
# The input name is just U+0627 (bidiclass: AL).
#
#             api: encodename
...
echo 'from: \u{627}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{627}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{627}' > output.txt
