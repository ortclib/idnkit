...
# The input name is just U+0041 (bidiclass: L).
#
#             api: encodename
...
echo 'to: A' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- 'A' > output.txt
