...
# The input name is just U+202A (bidiclass: LRE).
#
#             api: encodename
...
echo 'from: \u{202a}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{202a}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{202a}' > output.txt
