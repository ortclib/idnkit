...
# The input name is just U+0030 (bidiclass: EN).
#
#             api: encodename
...
echo 'from: 0' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: 0' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '0' > output.txt
