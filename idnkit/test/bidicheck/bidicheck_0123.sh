...
echo 'from: AA\u{300}.\u{5d0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: AA\u{300}.\u{5d0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- 'AA\u{300}.\u{5d0}' > output.txt
