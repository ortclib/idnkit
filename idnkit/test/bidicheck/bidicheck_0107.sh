...
# The input name is U+0041 U+002B U+0030 "." U+05D0
# (bidiclass: L ES EN . R).
#
#             api: encodename
...
echo 'from: A+0.\u{5d0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: A+0.\u{5d0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- 'A+0.\u{5d0}' > output.txt
