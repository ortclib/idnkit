...
# The input name is U+05D0 U+0025 U+0627 (bidiclass: R ET AL).
#
#             api: encodename
...
echo 'from: \u{5d0}%\u{627}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{5d0}%\u{627}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -bidicheck -localconv -- '\u{5d0}%\u{627}' > output.txt
