...
# In '-reverse' mode, set INPUT-CODESET to UTF-8 and OUTPUT-CODESET
# to U-escape.
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -reverse -in UTF-8 -out U-escape
#           input: à
#          output: \u{e0}
#        exitcode: 0
...
touch input.txt
echo 'à' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -reverse -in UTF-8 -out U-escape > output.txt 2>&1
