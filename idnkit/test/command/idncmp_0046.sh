...
#
#             api: command
#         command: ../../tools/idncmp/idncmp -help 2>&1 | head -1
#          output: Usage: idncmp [options..] name1 name2
#        exitcode: 0
...
echo 'Usage: idncmp [options..] name1 name2' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncmp/idncmp -help 2>&1 | head -1 > output.txt 2>&1
