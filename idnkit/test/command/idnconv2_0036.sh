...
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -skip idnconv,unknown aaa
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -skip idnconv,unknown aaa > output.txt 2>&1
