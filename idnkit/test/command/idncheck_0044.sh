...
#
#             api: command
#         command: ../../tools/idncheck/idncheck -help 2>&1 | head -1
#          output: Usage: idncheck [options..] name
#        exitcode: 0
...
echo 'Usage: idncheck [options..] name' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncheck/idncheck -help 2>&1 | head -1 > output.txt 2>&1
