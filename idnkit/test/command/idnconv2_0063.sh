...
# In '-reverse' mode, set INPUT-CODESET to Punycode and OUTPUT-CODESET
# to U-escape.
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -reverse -in Punycode -out U-escape
#           input: xn--0ca
#          output: \u{e0}
#        exitcode: 0
...
rm -f input.txt
touch input.txt
echo 'xn--0ca' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -reverse -in Punycode -out U-escape > output.txt 2>&1
