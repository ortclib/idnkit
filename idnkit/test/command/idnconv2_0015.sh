...
#            conf: delimiters 00a7
#         command: ../../tools/idnconv/idnconv2 -conf @CONF_FILE@ -noconf
#           input: === a\u{a7}b.jp ===
#          output: conversion failed at line 1: prohibited code point check failed
#        exitcode: 1
...
echo 'delimiters 00a7' >> idn2.conf
...
echo 'conversion failed at line 1: prohibited code point check failed' >> expect.txt
echo 'exitcode=1' >> expect.txt
rm -f input.txt
touch input.txt
echo '=== a\u{a7}b.jp ===' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -conf idn2.conf -noconf > output.txt 2>&1
