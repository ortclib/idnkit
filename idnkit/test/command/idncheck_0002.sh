...
#         command: ../../tools/idncheck/idncheck -c /dev/null XN--0CA..
#          output: label length check failed
#        exitcode: 2
...
echo 'label length check failed' >> expect.txt
echo 'exitcode=2' >> expect.txt
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncheck/idncheck -c /dev/null XN--0CA.. > output.txt 2>&1
