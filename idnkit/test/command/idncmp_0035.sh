...
#         command: ../../tools/idncmp/idncmp -c /dev/null -skip idnconv,,prohcheck aaa aaa
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncmp/idncmp -c /dev/null -skip idnconv,,prohcheck aaa aaa > output.txt 2>&1
