...
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -skip prohcheck -skip hyphcheck
#           input: === a\u{a7}b.-.jp ===
#          output: === xn--ab-nda.-.jp ===
#        exitcode: 0
...
echo '=== xn--ab-nda.-.jp ===' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
echo '=== a\u{a7}b.-.jp ===' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -skip prohcheck -skip hyphcheck > output.txt 2>&1
