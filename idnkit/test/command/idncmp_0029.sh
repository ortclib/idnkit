...
#         command: ../../tools/idncmp/idncmp -c /dev/null -skip prohcheck -skip hyphcheck @@- @@-
#          output: matched.
#        exitcode: 0
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncmp/idncmp -c /dev/null -skip prohcheck -skip hyphcheck @@- @@- > output.txt 2>&1
