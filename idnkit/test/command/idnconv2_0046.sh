...
# Test '-w' option with '-reverse'
#
#             api: command
#  local_encoding: U-escape
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -w -skip prohcheck -reverse
#           input: xn--=== a ===-t1a
#          output: === \u{e0}a ===
#        exitcode: 0
...
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -w -skip prohcheck -reverse > output.txt 2>&1
