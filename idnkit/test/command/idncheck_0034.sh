...
#         command: ../../tools/idncheck/idncheck -c /dev/null -quiet aaa | wc -l | sed -e 's/^ *//'
#          output: 0
#        exitcode: 0
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncheck/idncheck -c /dev/null -quiet aaa | wc -l | sed -e 's/^ *//' > output.txt 2>&1
