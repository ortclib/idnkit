...
#
#             api: command
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -in U-escape $SRCDIR/sample.txt
#          output: === xn--0ca ===
#        exitcode: 0
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -in U-escape $SRCDIR/sample.txt > output.txt 2>&1
