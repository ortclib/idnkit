...
# Test '-localcheck' option.
#
#             api: command
#  local_encoding: U-escape
#        localset: 0061..0062
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -localcheck @LOCALSET_FILE@
#           input: === a\u{e0}b ===
#          output: conversion failed at line 1: local check failed
#        exitcode: 1
...
echo 'conversion failed at line 1: local check failed' >> expect.txt
echo 'exitcode=1' >> expect.txt
rm -f input.txt
touch input.txt
echo '=== a\u{e0}b ===' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -localcheck localset > output.txt 2>&1
