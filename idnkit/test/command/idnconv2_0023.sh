...
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -registration -lookup
#           input: === \u{e0}.-.jp ===
#          output: === xn--0ca.-.jp ===
#        exitcode: 0
...
echo '=== xn--0ca.-.jp ===' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
echo '=== \u{e0}.-.jp ===' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -registration -lookup > output.txt 2>&1
