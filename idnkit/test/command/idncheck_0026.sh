...
# Test '-skip' option (with multiple action names).
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idncheck/idncheck -c /dev/null -skip prohcheck,hyphcheck @@-
#          output: passed.
#        exitcode: 0
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncheck/idncheck -c /dev/null -skip prohcheck,hyphcheck @@- > output.txt 2>&1
