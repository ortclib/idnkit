...
#
#             api: command
#         command: ../../tools/idnconv/idnconv2 -help 2>&1 | head -1
#          output: Usage: idnconv2 [options..] [file]
#        exitcode: 0
...
echo 'Usage: idnconv2 [options..] [file]' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -help 2>&1 | head -1 > output.txt 2>&1
