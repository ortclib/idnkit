...
# Set INPUT-CODESET to Punycode and OUTPUT-CODESET to U-escape.
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -in Punycode -out U-escape
#           input: xn--0ca
#          output: xn--0ca
#        exitcode: 0
...
echo 'xn--0ca' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
echo 'xn--0ca' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -in Punycode -out U-escape > output.txt 2>&1
