...
#         command: ../../tools/idncmp/idncmp -c /dev/null -registration -lookup aaa- aaa-
#          output: matched.
#        exitcode: 0
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncmp/idncmp -c /dev/null -registration -lookup aaa- aaa- > output.txt 2>&1
