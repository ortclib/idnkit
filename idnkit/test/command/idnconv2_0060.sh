...
# In '-whole' mode, set INPUT-CODESET to Punycode and OUTPUT-CODESET
# to U-escape.
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -whole -in Punycode -out U-escape
#           input: xn--0ca
#          output: \u{e0}
#        exitcode: 0
...
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -whole -in Punycode -out U-escape > output.txt 2>&1
