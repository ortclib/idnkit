...
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -whole -skip prohcheck
#           input: === \u{e0}a ===
#          output: xn--=== a ===-t1a
#        exitcode: 0
...
echo 'xn--=== a ===-t1a' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
echo '=== \u{e0}a ===' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -whole -skip prohcheck > output.txt 2>&1
