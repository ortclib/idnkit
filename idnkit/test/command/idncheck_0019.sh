...
# Specify both '-registration' and '-lookup' option.
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idncheck/idncheck -c /dev/null -registration -lookup aaa-
#          output: passed.
#        exitcode: 0
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idncheck/idncheck -c /dev/null -registration -lookup aaa- > output.txt 2>&1
