...
# Specify an input file, but the file doesn't exist.
#
#             api: command
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -in U-escape notexist.txt
#        exitcode: 1
...
rm -f input.txt
touch input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -in U-escape notexist.txt > /dev/null 2>&1
