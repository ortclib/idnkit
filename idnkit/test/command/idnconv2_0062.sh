...
# In '-reverse' mode, set INPUT-CODESET to U-escape and OUTPUT-CODESET
# to Punycode.
#
#             api: command
#  local_encoding: UTF-8
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -reverse -in U-escape -out Punycode
#           input: \u{e0}
#          output: xn--0ca
#        exitcode: 0
...
touch input.txt
echo '\u{e0}' >> input.txt
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -reverse -in U-escape -out Punycode > output.txt 2>&1
