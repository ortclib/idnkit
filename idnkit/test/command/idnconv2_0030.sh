...
#         command: ../../tools/idnconv/idnconv2 -c /dev/null -skip prohcheck,hyphcheck
#           input: === a\u{a7}b.-.jp ===
#          output: === xn--ab-nda.-.jp ===
#        exitcode: 0
...
cat input.txt | ../../tools/idnconv/idnconv2 -c /dev/null -skip prohcheck,hyphcheck > output.txt 2>&1
