...
# The map file defines a map for U+10FFFF.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map tld-local
#            conf: tld-local * @LOCALMAP_FILE1@
#       localmap1: 10FFFF; 0041;
#            from: \u{10ffff}BC.jp
...
echo 'from: \u{10ffff}BC.jp' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ABC.jp' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{10ffff}BC.jp' > output.txt
