...
# The map file defines a map for U+110000.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map tld-local
#            conf: tld-local * @LOCALMAP_FILE1@
#       localmap1: 110000; 0041;
#            from: \u{110000}BC.jp
...
echo 'from: \u{110000}BC.jp' >> expect.txt
echo 'result: idn_resconf_loadfile() ERROR: invalid code point' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{110000}BC.jp' > output.txt
