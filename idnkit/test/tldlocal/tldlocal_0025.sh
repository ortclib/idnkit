...
# For backward combility, idnkit allows to place 'filemap:' prefix
# in front of the localmap filename.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: language ja
#            conf: map tld-local
#            conf: tld-local * filemap:@LOCALMAP_FILE1@
#       localmap1: 0041; 0061;
#            from: ABC.jp
...
echo 'tld-local * filemap:localmap1' >> idn2.conf
