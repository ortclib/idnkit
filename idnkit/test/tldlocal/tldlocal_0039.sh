...
# The map file defines a map for U+E000.
#
#             api: encodename
...
echo 'from: \u{e000}BC.jp' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ABC.jp' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{e000}BC.jp' > output.txt
