...
# The map file defines a map for U+D7FF.
#
#             api: encodename
...
echo 'from: \u{d7ff}BC.jp' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ABC.jp' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{d7ff}BC.jp' > output.txt
