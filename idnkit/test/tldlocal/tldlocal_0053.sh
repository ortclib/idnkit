...
# Convert U+0041 (A) to U+0061 (a) when the current tld is Japanese.
#
#             api: decodename
...
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'ABC.jp' > output.txt
