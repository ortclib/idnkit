...
# The input name contains no unassigned code point, but a contexto
...
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -unascheck -localconv -- '\u{b7}' > output.txt
