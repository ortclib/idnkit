...
# The input name contains no unassigned code point, but a disallowed
# codecpoint (U+00C0), instead.
#
#             api: encodename
...
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -unascheck -localconv -- '\u{c0}' > output.txt
