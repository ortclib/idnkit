...
# The input name contains no unassigned code point, but a contextj
...
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -unascheck -localconv -- '\u{200c}' > output.txt
