...
#
# U+0130 lowercase conversion test.
...
echo 'from: \u{130}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: i' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{130}' > output.txt
