...
#
# More_Above test.
# The input name is "I-" + U+0307 ("I" + ccc=0 + ccc=230).
...
echo 'from: I-\u{300}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: i-\u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'I-\u{300}' > output.txt
