...
#
# Final_Sigma test.
# The input name is "a." + U+03A3 (Cased + Case_Ignorable + U+03A3).
# U+03A3 is not Final_Sigma in case of IDN.
#
#             api: encodename
#            conf: map lowercase
...
echo 'from: a.\u{3a3}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: a.\u{3c3}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'a.\u{3a3}' > output.txt
