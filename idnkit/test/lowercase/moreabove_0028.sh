...
#
# More_Above test.
# The input name is U+012E + U+0300... (U+012E + ccc=230...).
# The current language is not Lithuanian.
# U+012E not is More_Above.
#
#             api: encodename
#            conf: map lowercase
#            conf: language en
#  local_encoding: U-escape
#            from: \u{12e}\u{300}\u{300}\u{300}
#         actions: IDN_UNICODECONV IDN_MAP IDN_LOCALCONV
#          result: success
#              to: \u{12f}\u{300}\u{300}\u{300}
...
echo 'from: \u{12e}\u{300}\u{300}\u{300}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{12f}\u{300}\u{300}\u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{12e}\u{300}\u{300}\u{300}' > output.txt
