...
#
# Final_Sigma test.
# The input name is "a" + U+03A3 + ":::.a"
#     (Cased + U+03A3 + Case_Ignorable... + "." + Cased).
# U+03A3 is Final_Sigma in case of IDN.
#
#             api: encodename
#            conf: map lowercase
...
echo 'from: a\u{3a3}:::.a' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: a\u{3c2}:::.a' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'a\u{3a3}:::.a' > output.txt
