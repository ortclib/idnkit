...
#
# More_Above test.
# The input name is "J" + U+0307 ("J" + ccc=230).
...
echo 'from: J\u{307}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: j\u{307}\u{307}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'J\u{307}' > output.txt
