...
#
# More_Above test.
# The input name is "J" + U+0300... ("J" + ccc=230...).
...
#            from: J\u{300}\u{300}\u{300}
#         actions: IDN_UNICODECONV IDN_MAP IDN_LOCALCONV
#          result: success
#              to: j\u{300}\u{300}\u{300}
...
echo 'from: J\u{300}\u{300}\u{300}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: j\u{300}\u{300}\u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'J\u{300}\u{300}\u{300}' > output.txt
