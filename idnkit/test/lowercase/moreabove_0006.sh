...
#
# More_Above test.
# The input name is "I" + U+0334... + U+0300 ("I" + ccc=1... + ccc=230).
...
#            from: I\u{334}\u{334}\u{334}\u{300}
#         actions: IDN_UNICODECONV IDN_MAP IDN_LOCALCONV
#          result: success
#              to: i\u{334}\u{334}\u{334}\u{300}
...
echo 'from: I\u{334}\u{334}\u{334}\u{300}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: i\u{334}\u{334}\u{334}\u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'I\u{334}\u{334}\u{334}\u{300}' > output.txt
