...
#
# More_Above test.
# The input name is "J-" + U+0307 (U+012E + ccc=0 + ccc=230).
...
echo 'from: \u{12e}-\u{300}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{12f}-\u{300}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{12e}-\u{300}' > output.txt
