...
#
# U+00CD lowercase conversion test.
...
echo 'from: \u{cd}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{ed}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{cd}' > output.txt
