...
#
# U+00128 lowercase conversion test.
...
echo 'from: \u{128}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{129}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{128}' > output.txt
