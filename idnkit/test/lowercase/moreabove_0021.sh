...
echo 'from: \u{12e}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{12f}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{12e}' > output.txt
