...
echo 'from: \u{3a3}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{3c3}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{3a3}' > output.txt
