...
#
# Not_Before_Dot test.
# The input name is just "J".
# The current language is Azerbaijani.
# 'J' is Not_Before_Dot, but 'J' doesn't have a special casing rule.
#
#             api: encodename
#            conf: map lowercase
#            conf: language az
...
echo 'from: J' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: j' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'J' > output.txt
