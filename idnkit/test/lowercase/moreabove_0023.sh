...
#
# More_Above test.
# The input name is U+012E + U+0307 (U+012E + ccc=230).
...
echo 'from: \u{12e}\u{307}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{12f}\u{307}\u{307}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{12e}\u{307}' > output.txt
