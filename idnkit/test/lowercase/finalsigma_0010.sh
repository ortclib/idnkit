...
#
# Final_Sigma test.
# The input name is "a" + U+03A3 + U+03A3.
#     (Cased + U+03A3 + U+03A3).
# Only the second U+03A3 is Final_Sigma.
#
#             api: encodename
#            conf: map lowercase
...
echo 'from: a\u{3a3}\u{3a3}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: a\u{3c3}\u{3c2}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'a\u{3a3}\u{3a3}' > output.txt
