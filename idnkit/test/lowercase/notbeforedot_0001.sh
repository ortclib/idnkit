...
echo 'from: I' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{131}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'I' > output.txt
