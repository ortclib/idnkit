...
# (0000E1..0000E3; extra zero prefixes).
# The input name contains an invalid code point U+00E0.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#        localset: 0000E1..0000E3 # comment
#            from: \u{e1}\u{e2}\u{e3}\u{e0}
...
rm -f localmap4
rm -f localset
echo '0000E1..0000E3 # comment' >> localset
...
echo 'from: \u{e1}\u{e2}\u{e3}\u{e0}' >> expect.txt
echo 'result: local check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=localset  -unicodeconv -localcheck -localconv -- '\u{e1}\u{e2}\u{e3}\u{e0}' > output.txt
