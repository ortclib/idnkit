...
echo 'from: \u{e1}\u{e1}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{e1}\u{e1}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=localset  -unicodeconv -localcheck -localconv -- '\u{e1}\u{e1}' > output.txt
