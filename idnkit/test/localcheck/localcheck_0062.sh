...
#
# local check test.
# The input name is "" and also the code point set file has no definition.
#
#             api: encodename
...
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=localset  -unicodeconv -localcheck -localconv -- '' > output.txt
