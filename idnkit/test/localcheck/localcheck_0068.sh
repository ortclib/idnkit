...
#
# local check test.
# All code points in an input name are valid.
#
#             api: decodename
...
echo 'to: \u{e1}\u{e2}' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=localset  -unicodeconv -localcheck -localconv -- '\u{e1}\u{e2}' > output.txt
