...
# The input name is Punycode U+0080 (prohibited code point).
#
#             api: decodename
...
echo 'from: XN--A' >> expect.txt
echo 'result: prohibited code point check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -- 'XN--A' > output.txt
