...
# The input name is Punycode "XN--" + U+00E0.
#
#             api: decodename
...
echo 'from: XN--XN---3NA' >> expect.txt
echo 'result: ACE prefix check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -- 'XN--XN---3NA' > output.txt
