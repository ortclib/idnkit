...
# The input name is Punycode "-" + U+00E0.
#
#             api: decodename
...
echo 'from: XN----SFA' >> expect.txt
echo 'result: hyphen check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -- 'XN----SFA' > output.txt
