...
# The input name is U+200C (CONTEXTJ code point).
#
#             api: decodename
...
echo 'from: XN--0UG' >> expect.txt
echo 'result: CONTEXTJ check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -- 'XN--0UG' > output.txt
