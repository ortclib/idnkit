...
# The input name is Punycode U+E01F0 (unassigned code point).
#
#             api: decodename
...
echo 'from: XN--6J36E' >> expect.txt
echo 'result: unassigned code point check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-lookup -- 'XN--6J36E' > output.txt
