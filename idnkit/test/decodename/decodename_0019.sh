...
# The input name is Punycode U+0300 (ccc=230).
#
#             api: decodename
...
echo 'from: XN--KSA' >> expect.txt
echo 'result: combining character check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-lookup -- 'XN--KSA' > output.txt
