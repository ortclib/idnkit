...
# The input name contains a character not listed in a localcheck file.
#
#             api: decodename
...
#        localset: 0061..007A
#            from: XN--0CA
#         actions: IDN_DECODE_REGIST IDN_LOCALCHECK
...
echo 'from: XN--0CA' >> expect.txt
echo 'result: local check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=localset  -decode-regist -localcheck -- 'XN--0CA' > output.txt
