...
# The input name is Punycode U+0061 U+0300 ("A" + grave).
#
#             api: decodename
...
echo 'from: XN--A-VBB' >> expect.txt
echo 'result: NFC validation check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -- 'XN--A-VBB' > output.txt
