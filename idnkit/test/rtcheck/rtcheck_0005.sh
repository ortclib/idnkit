...
echo 'from: \u{e0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{e0}' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -idnconv -rtcheck -localconv -- '\u{e0}' > output.txt
