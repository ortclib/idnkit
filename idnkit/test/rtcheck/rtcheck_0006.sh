...
# The input name is an LDH label.
#
#             api: decodename
...
echo 'from: example' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: example' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -idnconv -rtcheck -localconv -- 'example' > output.txt
