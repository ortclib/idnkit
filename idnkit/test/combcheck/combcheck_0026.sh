...
# The first character of the input name is U+2029 (General_Category=Zp).
#
#             api: encodename
...
echo 'from: \u{2029}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{2029}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{2029}' > output.txt
