...
# The first character of the input name is U+00AB (General_Category=Pi).
#
#             api: encodename
...
echo 'from: \u{ab}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{ab}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{ab}' > output.txt
