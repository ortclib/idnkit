...
# The first character of the input name is U+0F3B (General_Category=Pe).
#
#             api: encodename
...
echo 'from: \u{f3b}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{f3b}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{f3b}' > output.txt
