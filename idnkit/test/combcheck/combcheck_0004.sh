...
# The first character of the input name is U+00A2 (General_Category=Sc).
#
#             api: encodename
...
echo 'from: \u{a2}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{a2}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{a2}' > output.txt
