...
# The first character of the input name is U+0660 (General_Category=Nd).
#
#             api: encodename
...
echo 'from: \u{660}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{660}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{660}' > output.txt
