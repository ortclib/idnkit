...
# The first character of the input name is U+00A6 (General_Category=So).
#
#             api: encodename
...
echo 'from: \u{a6}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{a6}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{a6}' > output.txt
