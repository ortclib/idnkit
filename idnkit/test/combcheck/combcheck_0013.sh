...
# The first character of the input name is U+00C0 (General_Category=Lu).
#
#             api: encodename
...
echo 'to: \u{c0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{c0}' > output.txt
