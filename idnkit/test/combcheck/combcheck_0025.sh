...
# The first character of the input name is U+2028 (General_Category=Zl).
#
#             api: encodename
...
echo 'from: \u{2028}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{2028}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{2028}' > output.txt
