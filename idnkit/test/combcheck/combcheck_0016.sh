...
# The first character of the input name is U+02B0 (General_Category=Lm).
#
#             api: encodename
...
echo 'from: \u{2b0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{2b0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{2b0}' > output.txt
