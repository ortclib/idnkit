...
# The first character of the input name is U+058A (General_Category=Pd).
#
#             api: encodename
...
echo 'from: \u{58a}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{58a}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{58a}' > output.txt
