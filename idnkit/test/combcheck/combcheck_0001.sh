...
# The first character of the input name is U+0080 (General_Category=Cc).
#
#             api: encodename
...
echo 'from: \u{80}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{80}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{80}' > output.txt
