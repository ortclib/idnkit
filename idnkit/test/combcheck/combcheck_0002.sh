...
# The first character of the input name is U+00A0 (General_Category=Zs).
#
#             api: encodename
...
echo 'from: \u{a0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{a0}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{a0}' > output.txt
