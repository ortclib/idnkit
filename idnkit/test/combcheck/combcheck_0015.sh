...
# The first character of the input name is U+01C5 (General_Category=Lt).
#
#             api: encodename
...
echo 'from: \u{1c5}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{1c5}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{1c5}' > output.txt
