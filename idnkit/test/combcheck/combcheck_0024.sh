...
# The first character of the input name is U+16EE (General_Category=Nl).
#
#             api: encodename
...
echo 'from: \u{16ee}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{16ee}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{16ee}' > output.txt
