...
# The first character of the input name is U+0F3A (General_Category=Ps).
#
#             api: encodename
...
echo 'from: \u{f3a}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{f3a}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{f3a}' > output.txt
