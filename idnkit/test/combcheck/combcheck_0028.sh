...
# The first character of the input name is U+E000 (General_Category=Co).
#
#             api: encodename
...
echo 'to: \u{e000}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{e000}' > output.txt
