...
# The first character of the input name is U+00BB (General_Category=Pf).
#
#             api: encodename
...
echo 'from: \u{bb}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{bb}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{bb}' > output.txt
