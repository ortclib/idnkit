...
# The first character of the input name is U+203F (General_Category=Pc).
#
#             api: encodename
...
echo 'from: \u{203f}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{203f}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{203f}' > output.txt
