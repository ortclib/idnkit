...
# The first character of the input name is U+01BB (General_Category=Lo).
#
#             api: encodename
...
echo 'from: \u{1bb}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{1bb}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{1bb}' > output.txt
