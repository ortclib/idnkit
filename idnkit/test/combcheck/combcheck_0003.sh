...
# The first character of the input name is U+00A1 (General_Category=Po).
#
#             api: encodename
...
echo 'from: \u{a1}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{a1}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{a1}' > output.txt
