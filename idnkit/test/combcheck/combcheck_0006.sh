...
# The first character of the input name is U+00A8 (General_Category=Sk).
#
#             api: encodename
...
echo 'from: \u{a8}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{a8}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{a8}' > output.txt
