...
# The first character of the input name is U+00AD (General_Category=Cf).
#
#             api: encodename
...
echo 'to: \u{ad}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -combcheck -localconv -- '\u{ad}' > output.txt
