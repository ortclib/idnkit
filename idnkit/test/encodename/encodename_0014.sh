...
echo 'from: \u{e0}.\u{e0}.\u{e0}.' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: xn--0ca.xn--0ca.xn--0ca.' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-regist -- '\u{e0}.\u{e0}.\u{e0}.' > output.txt
