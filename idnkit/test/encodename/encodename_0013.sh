...
# The input name contains both U-label and A label.
#
#             api: encodename
...
echo 'from: XN--0CA.\u{e0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: xn--0ca.xn--0ca' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-regist -- 'XN--0CA.\u{e0}' > output.txt
