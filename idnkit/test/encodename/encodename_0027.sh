...
#        localset: 0061..007A
#            from: 123
#         actions: IDN_ENCODE_LOOKUP IDN_LOCALCHECK
...
echo 'from: 123' >> expect.txt
echo 'result: local check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=localset  -encode-lookup -localcheck -- '123' > output.txt
