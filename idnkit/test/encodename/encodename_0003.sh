...
# The input name is U+E01F0 (unassigned code point).
#
#             api: encodename
...
echo 'from: \u{e01f0}' >> expect.txt
echo 'result: unassigned code point check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-regist -- '\u{e01f0}' > output.txt
