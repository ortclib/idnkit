...
# The input name is U+0640 U+200C U+062F
# (Joining_Type:C + U+200C + Joining_Type:R).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{640}\u{200c}\u{62f}
...
echo 'from: \u{640}\u{200c}\u{62f}' >> expect.txt
echo 'result: CONTEXTJ check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{640}\u{200c}\u{62f}' > output.txt
