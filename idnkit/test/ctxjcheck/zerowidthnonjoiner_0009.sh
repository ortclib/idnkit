...
# The input name is U+0628 U+200C U+062F
# (Joining_Type:D + U+200C + Joining_Type:R).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{628}\u{200c}\u{62f}
#         actions: IDN_UNICODECONV IDN_CTXJCHECK IDN_LOCALCONV
#          result: success
#              to: \u{628}\u{200c}\u{62f}
...
echo 'from: \u{628}\u{200c}\u{62f}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{628}\u{200c}\u{62f}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{628}\u{200c}\u{62f}' > output.txt
