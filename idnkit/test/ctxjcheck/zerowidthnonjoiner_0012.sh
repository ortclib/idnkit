...
# The input name is U+0628 U+200C U+0061
# (Joining_Type:D + U+200C + Joining_Type:U).
#
#             api: encodename
...
echo 'from: \u{628}\u{200c}a' >> expect.txt
echo 'result: CONTEXTJ check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{628}\u{200c}a' > output.txt
