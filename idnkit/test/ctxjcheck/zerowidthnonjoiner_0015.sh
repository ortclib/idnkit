...
# The input name is U+0628 U+200C U+00AD
# (Joining_Type:D + U+200C + Joining_Type:T).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{628}\u{200c}\u{ad}
...
echo 'from: \u{628}\u{200c}\u{ad}' >> expect.txt
echo 'result: CONTEXTJ check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{628}\u{200c}\u{ad}' > output.txt
