...
# The input name is U+200D U+094D (U+002C + Virama).
#
#             api: encodename
...
echo 'from: \u{200d}\u{94d}' >> expect.txt
echo 'result: CONTEXTJ check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{200d}\u{94d}' > output.txt
