...
#
# ZERO WIDTH JOINER context rule test.
# The input name is U+094D U+200D (Virama + U+002C).
#
#             api: encodename
...
echo 'from: \u{94d}\u{200d}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{94d}\u{200d}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{94d}\u{200d}' > output.txt
