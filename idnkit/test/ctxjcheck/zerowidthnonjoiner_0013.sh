...
echo 'from: \u{628}\u{200c}\u{628}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{628}\u{200c}\u{628}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{628}\u{200c}\u{628}' > output.txt
