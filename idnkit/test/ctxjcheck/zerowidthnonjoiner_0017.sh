...
# The input name isU+00AD... U+200C U+00AD... U+0628
# (Joining_Type:T... + U+200C + Joining_Type:T... + Joining_Type:D).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{ad}\u{ad}\u{ad}\u{200c}\u{ad}\u{ad}\u{ad}\u{628}
...
echo 'from: \u{ad}\u{ad}\u{ad}\u{200c}\u{ad}\u{ad}\u{ad}\u{628}' >> expect.txt
echo 'result: CONTEXTJ check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxjcheck -localconv -- '\u{ad}\u{ad}\u{ad}\u{200c}\u{ad}\u{ad}\u{ad}\u{628}' > output.txt
