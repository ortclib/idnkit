...
echo 'from: \u{e0}\u{e0}--a' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{e0}\u{e0}--a' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -prefcheck -- '\u{e0}\u{e0}--a' > output.txt
