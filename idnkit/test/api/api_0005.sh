...
#
# Test idn_comparenames().
# NAME1 != NAME2.
#
#             api: command
#  local_encoding: U-escape
#         command: ./test_api_comparenames '\u{e1}' 'xn--0ca'
#          output: not equivalent domain names
#        exitcode: 0
...
echo 'not equivalent domain names' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
cat input.txt | ./test_api_comparenames '\u{e1}' 'xn--0ca' > output.txt 2>&1
