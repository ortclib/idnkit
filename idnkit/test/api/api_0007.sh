...
#
# Test idn_comparenames2().
# NAME1 != NAME2.
#
#             api: command
#  local_encoding: U-escape
#         command: ./test_api_comparenames2 'xn--0ca' '\u{e0}'
#          output: idn_comparenames2() ERROR: prohibited code point check failed
#        exitcode: 0
...
echo 'idn_comparenames2() ERROR: prohibited code point check failed' >> expect.txt
echo 'exitcode=0' >> expect.txt
rm -f input.txt
touch input.txt
cat input.txt | ./test_api_comparenames2 'xn--0ca' '\u{e0}' > output.txt 2>&1
