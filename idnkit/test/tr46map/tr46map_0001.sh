...
#
# TR #46 maping test.
# The input name is U+0133 (LATIN SMALL LIGATURE IJ).
# It is converted to U+0069 U+006A ("ij").
#
#             api: encodename
...
echo 'from: \u{133}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ij' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{133}' > output.txt
