...
# The input name is "ABCDEFGHIJKLMNOPQRSTUVWXYZ-0123456789".
#
#             api: encodename
...
echo 'from: ABCDEFGHIJKLMNOPQRSTUVWXYZ-0123456789' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: abcdefghijklmnopqrstuvwxyz-0123456789' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -asclower -localconv -- 'ABCDEFGHIJKLMNOPQRSTUVWXYZ-0123456789' > output.txt
