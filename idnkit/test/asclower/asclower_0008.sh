...
echo 'from: a\u{e0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: a\u{e0}' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -asclower -localconv -- 'a\u{e0}' > output.txt
