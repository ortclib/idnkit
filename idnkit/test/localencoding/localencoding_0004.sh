...
#
# Local encoding test.
# Determine the local encoding from the environment variable IDN_LOCAL_CODESET.
#
#             api: localencoding
#             env: IDN_LOCAL_CODESET=eucJP
#            conf: 
#  encoding_alias: 
#          expect: eucJP
...
IGNORE=false
export IDN_LOCAL_CODESET; IDN_LOCAL_CODESET=eucJP
