...
# Define alias for the same encoding name twice.
#
#             api: localencoding
#  local_encoding: xxx_XXX
#            conf: 
#  encoding_alias: xxx_XXX UTF-8
#  encoding_alias: xxx_XXX yyy_YYY
#          expect: UTF-8
...
( echo 'xxx_XXX UTF-8' >> ${SYSCONFDIR}/idnalias.conf )
( echo 'xxx_XXX yyy_YYY' >> ${SYSCONFDIR}/idnalias.conf )
