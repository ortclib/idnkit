...
../common/test_comparenames2 -conffile=idn2.conf -localcheckfile=  -unicodeconv -idnconv -- '\u{4e00}\u{81f4}.xn--4gq997j.jp'  -compare-lookup -- 'xn--4gq997j.\u{4e00}\u{81f4}.jp' > output.txt
