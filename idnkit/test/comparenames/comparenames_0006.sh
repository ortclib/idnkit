...
# FROM1 + "." = FROM2, but idnkit doesn't think they are the same.
#
#             api: comparenames
...
../common/test_comparenames -conffile=idn2.conf -localcheckfile=  -compare-lookup -- '\u{4e00}\u{81f4}.XN--4GQ997J.JP' 'xn--4gq997j.\u{4e00}\u{81f4}.jp.' > output.txt
