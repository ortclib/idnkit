...
# actions = 0. FROM1 != FROM2.
#
#             api: comparenames
#  local_encoding: U-escape
#            conf: 
#           from1: XN--4GQ997J.JP.
#           from2: xn--4gqza5537a.JP
#         actions: 
...
echo 'from2: xn--4gqza5537a.JP' >> expect.txt
echo 'result: not equivalent domain names' >> expect.txt
../common/test_comparenames -conffile=idn2.conf -localcheckfile=  -- 'XN--4GQ997J.JP.' 'xn--4gqza5537a.JP' > output.txt
