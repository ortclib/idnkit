...
# The input name is not valid because it contains U+110000 (code point
# over U+10FFFF).
#
#             api: decodename
...
echo 'from: xn--en32g' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -idnconv -localconv -- 'xn--en32g' > output.txt
