...
# The input name is not valid because it contains U+DFFF (code point
...
echo 'from: xn--zx0c' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -idnconv -localconv -- 'xn--zx0c' > output.txt
