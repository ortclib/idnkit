...
# The input name is not valid because it contains U+D800 (code point
# used for surrogate pair).
#
#             api: decodename
...
echo 'from: xn--ib9b' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -idnconv -localconv -- 'xn--ib9b' > output.txt
