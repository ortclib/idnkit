...
# The last line of the configuration file name lacks a newline.
# Use 'no-newline.conf' as the configuration file, and it defines
# 'delimiters 0040'.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#      post_setup: cp -f $SRCDIR/no-newline.conf @CONF_FILE@
#            from: A@B
...
cp -f $SRCDIR/no-newline.conf idn2.conf
...
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-regist -- 'A@B' > output.txt
