...
# The input name is U+3042 U+30FB U+30A2 U+8A66.
#
...
#            conf: 
#            from: \u{3042}\u{30fb}\u{30a2}\u{8a66}
#         actions: IDN_UNICODECONV IDN_CTXOCHECK IDN_LOCALCONV
#          result: success
#              to: \u{3042}\u{30fb}\u{30a2}\u{8a66}
...
echo 'from: \u{3042}\u{30fb}\u{30a2}\u{8a66}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{3042}\u{30fb}\u{30a2}\u{8a66}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{3042}\u{30fb}\u{30a2}\u{8a66}' > output.txt
