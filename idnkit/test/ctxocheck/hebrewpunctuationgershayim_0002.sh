...
# The input name is U+0061 U+05F4
#
#             api: encodename
...
echo 'from: a\u{5f4}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- 'a\u{5f4}' > output.txt
