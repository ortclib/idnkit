...
# The input name is just U+06F2 (ARABIC-INDIC DIGIT TWO).
#
#             api: encodename
...
echo 'from: \u{662}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{662}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{662}' > output.txt
