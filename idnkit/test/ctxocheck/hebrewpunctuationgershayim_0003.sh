...
# The input name is U+05D0 U+05F4 (U+05D0 belongs to Hebrew).
#
#             api: encodename
...
echo 'from: \u{5d0}\u{5f4}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{5d0}\u{5f4}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{5d0}\u{5f4}' > output.txt
