...
# The input name is just U+0663 U+06F6
# (ARABIC-INDIC DIGIT THREE and EXTENDED ARABIC-INDIC DIGIT SIX).
#
#             api: encodename
...
echo 'from: \u{663}\u{6f6}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{663}\u{6f6}' > output.txt
