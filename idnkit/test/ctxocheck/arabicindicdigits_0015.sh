...
# The input name is just U+0664 U+06F5
# (ARABIC-INDIC DIGIT FOUR and EXTENDED ARABIC-INDIC DIGIT FIVE).
#
#             api: encodename
...
echo 'from: \u{664}\u{6f5}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{664}\u{6f5}' > output.txt
