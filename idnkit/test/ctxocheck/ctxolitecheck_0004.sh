...
#            conf: 
#            from: .
#         actions: IDN_UNICODECONV IDN_CTXOLITECHECK IDN_LOCALCONV
#          result: success
#              to: .
...
echo 'to: .' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxolitecheck -localconv -- '.' > output.txt
