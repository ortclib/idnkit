...
# The input name is U+0375 U+0370 (U+0370 belongs to Greek).
#
#             api: encodename
...
echo 'from: \u{375}\u{370}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{375}\u{370}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{375}\u{370}' > output.txt
