...
# The input name is U+3042 U+30FB. (U+3042 belongs to Hiragana)
#
#             api: encodename
...
echo 'from: \u{3042}\u{30fb}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{3042}\u{30fb}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{3042}\u{30fb}' > output.txt
