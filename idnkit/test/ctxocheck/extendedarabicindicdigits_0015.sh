...
# The input name is just U+06F5 U+0664
# (EXTENDED ARABIC-INDIC DIGIT FOUR and ARABIC-INDIC DIGIT FIVE).
#
#             api: encodename
...
echo 'from: \u{6f5}\u{664}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{6f5}\u{664}' > output.txt
