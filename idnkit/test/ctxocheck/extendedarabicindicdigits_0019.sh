...
#
# EXTENDED ARABIC-INDIC DIGITS context rule test.
# The input name is just U+06F1 U+0668
# (EXTENDED ARABIC-INDIC DIGIT EIGHT and ARABIC-INDIC DIGIT ONE).
#
#             api: encodename
...
echo 'from: \u{6f1}\u{668}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{6f1}\u{668}' > output.txt
