...
# The input name is just U+06F7 (ARABIC-INDIC DIGIT SEVEN).
#
#             api: encodename
...
echo 'from: \u{667}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{667}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{667}' > output.txt
