...
# The input name is U+0375 U+0061
#
#             api: encodename
...
echo 'from: \u{375}a' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{375}a' > output.txt
