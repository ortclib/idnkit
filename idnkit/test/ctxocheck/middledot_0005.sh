...
# The input name is U+006C U+00B7 U+006C U+00B7 U+006C.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: l\u{b7}l\u{b7}l
...
echo 'from: l\u{b7}l\u{b7}l' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: l\u{b7}l\u{b7}l' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- 'l\u{b7}l\u{b7}l' > output.txt
