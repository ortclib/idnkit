...
# The input name is just U+06F4 U+0665
# (EXTENDED ARABIC-INDIC DIGIT FIVE and ARABIC-INDIC DIGIT FOUR).
#
#             api: encodename
...
echo 'from: \u{6f4}\u{665}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{6f4}\u{665}' > output.txt
