...
# The input name is just U+06F4 (ARABIC-INDIC DIGIT FOUR).
#
#             api: encodename
...
echo 'from: \u{664}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{664}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{664}' > output.txt
