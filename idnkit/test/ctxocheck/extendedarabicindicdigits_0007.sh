...
# The input name is just U+06F6 (ARABIC-INDIC DIGIT SIX).
#
#             api: encodename
...
echo 'from: \u{666}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{666}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{666}' > output.txt
