...
# The input name is just U+0669 U+06F0
# (ARABIC-INDIC DIGIT NINE and EXTENDED ARABIC-INDIC DIGIT ZERO).
#
#             api: decodename
...
echo 'from: \u{669}\u{6f0}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{669}\u{6f0}' > output.txt
