...
# The input name is U+0375... (Both U+0375 belongs to Greek).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{375}\u{375}\u{375}
...
echo 'from: \u{375}\u{375}\u{375}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{375}\u{375}\u{375}' > output.txt
