...
# The input name is just U+06F1 (ARABIC-INDIC DIGIT ONE).
#
#             api: encodename
...
echo 'from: \u{661}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{661}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{661}' > output.txt
