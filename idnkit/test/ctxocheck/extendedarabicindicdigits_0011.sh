...
# The input name is just U+06F9 U+0660
# (EXTENDED ARABIC-INDIC DIGIT ZERO and ARABIC-INDIC DIGIT NINE).
#
#             api: encodename
...
echo 'from: \u{6f9}\u{660}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{6f9}\u{660}' > output.txt
