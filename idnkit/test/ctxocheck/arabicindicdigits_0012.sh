...
# The input name is just U+0661 U+06F8
# (ARABIC-INDIC DIGIT ONE and EXTENDED ARABIC-INDIC DIGIT EIGHT).
#
#             api: encodename
...
echo 'from: \u{661}\u{6f8}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{661}\u{6f8}' > output.txt
