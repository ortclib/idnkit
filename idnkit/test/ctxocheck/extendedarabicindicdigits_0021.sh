...
# The input name is just U+06F0 U+0669
# (EXTENDED ARABIC-INDIC DIGIT NINE and ARABIC-INDIC DIGIT ZERO).
#
#             api: decodename
...
echo 'from: \u{6f0}\u{669}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{6f0}\u{669}' > output.txt
