...
# The input name is U+30FB U+30A2. (U+30A2 belongs to Katakana)
#
#             api: encodename
...
echo 'from: \u{30fb}\u{30a2}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{30fb}\u{30a2}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{30fb}\u{30a2}' > output.txt
