...
# The input name is just U+30FB U+0061. (U+0061 belongs to Common)
#
#             api: encodename
...
echo 'from: \u{30fb}a' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{30fb}a' > output.txt
