...
# The input name is U+05F3... (Both U+05F3 belongs to Hebrew).
#
#             api: encodename
#  local_encoding: U-escape
#            conf: 
#            from: \u{5f3}\u{5f3}\u{5f3}
...
echo 'from: \u{5f3}\u{5f3}\u{5f3}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{5f3}\u{5f3}\u{5f3}' > output.txt
