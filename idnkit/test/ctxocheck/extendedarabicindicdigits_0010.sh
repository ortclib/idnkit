...
# The input name is just U+06F9 (ARABIC-INDIC DIGIT NINE).
#
#             api: encodename
...
echo 'from: \u{669}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{669}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{669}' > output.txt
