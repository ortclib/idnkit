...
# The input name is just U+06F3 U+0666
# (EXTENDED ARABIC-INDIC DIGIT SIX and ARABIC-INDIC DIGIT THREE).
#
#             api: encodename
...
echo 'from: \u{6f3}\u{666}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{6f3}\u{666}' > output.txt
