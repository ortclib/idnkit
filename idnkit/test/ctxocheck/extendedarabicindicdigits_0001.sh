...
# The input name is just U+06F0 (ARABIC-INDIC DIGIT ZERO).
#
#             api: encodename
...
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{660}' > output.txt
