...
# The input name is just U+0665 U+06F4
# (ARABIC-INDIC DIGIT FIVE and EXTENDED ARABIC-INDIC DIGIT FOUR).
#
#             api: encodename
...
echo 'from: \u{665}\u{6f4}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{665}\u{6f4}' > output.txt
