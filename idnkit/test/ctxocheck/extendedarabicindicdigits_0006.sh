...
# The input name is just U+06F5 (ARABIC-INDIC DIGIT FIVE).
#
#             api: encodename
...
echo 'from: \u{665}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{665}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{665}' > output.txt
