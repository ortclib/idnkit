...
# The input name is U+30FB U+3042. (U+3042 belongs to Hiragana)
#
#             api: encodename
...
echo 'from: \u{30fb}\u{3042}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{30fb}\u{3042}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{30fb}\u{3042}' > output.txt
