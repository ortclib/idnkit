...
# The input name is U+30FB U+8A66. (U+30A2 belongs to Han)
#
#             api: encodename
...
echo 'from: \u{30fb}\u{8a66}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{30fb}\u{8a66}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{30fb}\u{8a66}' > output.txt
