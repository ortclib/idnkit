...
# The input name is just U+06F3 (ARABIC-INDIC DIGIT THREE).
#
#             api: encodename
...
echo 'from: \u{663}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{663}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{663}' > output.txt
