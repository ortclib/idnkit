...
# The input name is just U+0666 U+06F3
# (ARABIC-INDIC DIGIT SIX and EXTENDED ARABIC-INDIC DIGIT THREE).
#
#             api: encodename
...
echo 'from: \u{666}\u{6f3}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{666}\u{6f3}' > output.txt
