...
# The input name is just U+0668 U+06F1
# (ARABIC-INDIC DIGIT EIGHT and EXTENDED ARABIC-INDIC DIGIT ONE).
#
#             api: encodename
...
echo 'from: \u{668}\u{6f1}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{668}\u{6f1}' > output.txt
