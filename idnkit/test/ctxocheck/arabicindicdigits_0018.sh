...
# The input name is just U+0667 U+06F2
# (ARABIC-INDIC DIGIT SEVEN and EXTENDED ARABIC-INDIC DIGIT TWO).
#
#             api: encodename
...
echo 'from: \u{667}\u{6f2}' >> expect.txt
echo 'result: CONTEXTO check failed' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{667}\u{6f2}' > output.txt
