...
# The input name is just U+06F8 (ARABIC-INDIC DIGIT EIGHT).
#
#             api: encodename
...
echo 'from: \u{668}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{668}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -ctxocheck -localconv -- '\u{668}' > output.txt
