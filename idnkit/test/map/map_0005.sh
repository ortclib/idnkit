...
#
# Maaping test.
# In a configuration file, specify invalid mapping name "NFC".
#
#             api: encodename
...
#          result: idn_resconf_loadfile() ERROR: invalid name
#              to: 
...
echo 'from: aaa' >> expect.txt
echo 'result: idn_resconf_loadfile() ERROR: invalid name' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'aaa' > output.txt
