...
#
# Maaping test.
# Combined map procedure name "resman-idna2008-mappings-01".
#
#             api: decodename
#  local_encoding: U-escape
#            conf: map resman-idna2008-mappings-01
#            from: \u{c0}\u{ff61}\u{c0}
...
rm -f idn2.conf
touch idn2.conf
echo 'map resman-idna2008-mappings-01' >> idn2.conf
...
echo 'from: \u{c0}\u{ff61}\u{c0}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{e0}.\u{e0}' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{c0}\u{ff61}\u{c0}' > output.txt
