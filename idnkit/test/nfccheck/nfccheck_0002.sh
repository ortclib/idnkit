...
# The input name is U+00B5 (NFC, but not NFKC).
#
#             api: encodename
...
echo 'from: \u{b5}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{b5}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -nfccheck -localconv -- '\u{b5}' > output.txt
