...
# The input name is "\xe0\xa0\x80" which represetns "U+0800".
#
#             api: decodename2
...
echo 'from: ࠀ' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{800}' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'ࠀ' > output.txt
