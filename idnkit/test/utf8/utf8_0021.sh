...
# The input name is "\xf0\x90\x80\x80" which represetns "U+10000".
#
#             api: decodename2
...
echo 'from: 𐀀' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{10000}' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- '𐀀' > output.txt
