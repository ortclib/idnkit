...
# The input name is "\xc1\xbf"
# This is an invalid UTF-8 string since it represents U+007F with three bytes.
#
#             api: decodename2
...
echo 'from: Á¿' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'Á¿' > output.txt
