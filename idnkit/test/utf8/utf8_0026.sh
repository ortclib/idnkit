...
# The input name is "\xe0\xa0".
# This is an invalid UTF-8 string since it lacks the third byte.
#
#             api: decodename2
...
echo 'from: ра' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'ра' > output.txt
