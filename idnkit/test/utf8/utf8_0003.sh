...
# The input name is "\xdf".
# This is an invalid UTF-8 string since the first byte is "10xxxxxx".
#
#             api: decodename2
...
echo 'from: ß' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'ß' > output.txt
