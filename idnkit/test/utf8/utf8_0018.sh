...
# The input name is "\xe0\x7f\x80\x80".
# This is an invalid UTF-8 string since the second byte is not "10xxxxxx".
#
#             api: decodename2
...
echo 'from: ñ€€' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'ñ€€' > output.txt
