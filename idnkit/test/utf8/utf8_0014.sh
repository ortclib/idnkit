...
# The input name is "\xed\xbf\xbf" which represetns "U+DFFF";
# U+D800 is used for surrogate pair.
#
#             api: decodename2
...
echo 'from: í¿¿' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'í¿¿' > output.txt
