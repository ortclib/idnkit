...
# The input name is "\xe0\x9f\xbf".
# This is an invalid UTF-8 string since it represents U+07FF with three bytes.
#
#             api: decodename2
...
echo 'from: àŸ¿' >> expect.txt
echo 'result: invalid encoding found' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename2 -conffile=idn2.conf -localcheckfile= -auxencoding=UTF-8  -localconv -- 'àŸ¿' > output.txt
