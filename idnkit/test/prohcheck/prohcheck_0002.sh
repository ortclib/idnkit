...
# The input name contains no prohibited code point, but a disallowed
# codecpoint (U+EFFFD), instead.
#
#             api: encodename
...
echo 'to: \u{efffd}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -prohcheck -localconv -- '\u{efffd}' > output.txt
