...
# The input name contains no prohibited code point, but a contextj
# codecpoint U+200C, instead.
#
#             api: encodename
...
echo 'from: \u{200c}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{200c}' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -prohcheck -localconv -- '\u{200c}' > output.txt
