...
#
# NFKC test.
# The input name is U+213B (FACSIMILE SIGN).
# It is converted to "FAX".
#
#             api: encodename
...
echo 'from: \u{213b}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: FAX' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{213b}' > output.txt
