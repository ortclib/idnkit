...
# Determine the the current language from the configuration, but
# the language name is written in uppercase letters.  Furthermore,
# it is an ISO-639-2 code and the corresponding ISO-639-1 code exists.
#
#             api: language
#            conf: language jPN
#  language_alias: 
