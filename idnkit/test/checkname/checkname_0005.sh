...
#
# idn_res_checkname() test.
# Use IDN_CHECK_LOOKUP.
#
#             api: checkname
#  local_encoding: U-escape
#            conf: 
#            from: \u{4e00}\u{81f4}-.jp
...
echo 'from: \u{4e00}\u{81f4}-.jp' >> expect.txt
echo 'result: success' >> expect.txt
../common/test_checkname -conffile=idn2.conf -localcheckfile=  -check-lookup -- '\u{4e00}\u{81f4}-.jp' > output.txt
