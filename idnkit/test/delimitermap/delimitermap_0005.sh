...
# Reigister 0x3, 0x33 and 0x333 (1..3 hex digits) as delimiters.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map delimitermap
#            conf: delimiters 3 33 333
#            from: \u{3}\u{33}\u{333}
...
echo 'delimiters 3 33 333' >> idn2.conf
...
echo 'from: \u{3}\u{33}\u{333}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ...' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{3}\u{33}\u{333}' > output.txt
