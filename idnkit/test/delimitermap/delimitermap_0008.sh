...
# Reigster U+3002 (default delimiter) as a delimiter.
#
#             api: encodename
...
echo 'from: \u{3002}\u{3002}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ..' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{3002}\u{3002}' > output.txt
