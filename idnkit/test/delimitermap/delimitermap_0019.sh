...
# Reigster no code point as a delimiter.
#
#             api: encodename
...
echo 'from: ABC\u{3002}DEF' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ABC\u{3002}DEF' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'ABC\u{3002}DEF' > output.txt
