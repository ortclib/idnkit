...
# Reigster U+D800 as a delimiter.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map delimitermap
#            conf: delimiters d800
#            from: \u{d800}
...
echo 'delimiters d800' >> idn2.conf
...
echo 'from: \u{d800}' >> expect.txt
echo 'result: idn_resconf_loadfile() ERROR: invalid code point' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{d800}' > output.txt
