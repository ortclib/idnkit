...
# Reigister U+10FFFF as a delimiter.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map delimitermap
#            conf: delimiters 10FFFF
#            from: \u{10ffff}
...
echo 'delimiters 10FFFF' >> idn2.conf
...
echo 'to: .' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{10ffff}' > output.txt
