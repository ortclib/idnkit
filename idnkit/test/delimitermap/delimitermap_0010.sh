...
# Reigster U+D7FF as a delimiter.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map delimitermap
#            conf: delimiters d7ff
#            from: \u{d7ff}
...
echo 'delimiters d7ff' >> idn2.conf
...
echo 'from: \u{d7ff}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: .' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{d7ff}' > output.txt
