...
# Reigster U+002E (FULL STOP) as a delimiter.
# No conversion occurs.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map delimitermap
#            conf: delimiters 002E
#            from: .
...
echo 'delimiters 002E' >> idn2.conf
...
echo 'to: .' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '.' > output.txt
