...
# Reigister U+110000 (over U+10FFFF) as a delimiter.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map delimitermap
#            conf: delimiters 110000
#            from: ABCDE
...
echo 'delimiters 110000' >> idn2.conf
...
echo 'from: ABCDE' >> expect.txt
echo 'result: idn_resconf_loadfile() ERROR: invalid code point' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- 'ABCDE' > output.txt
