...
#
# IDN_UNDOIFERR test.
# The input name is U+0300 (ccc=230) + U+0041 ("A").
#
#             api: encodename
...
echo 'from: \u{300}A' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{300}a' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-regist -localconv -undoiferr -- '\u{300}A' > output.txt
