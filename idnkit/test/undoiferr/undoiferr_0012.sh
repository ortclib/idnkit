...
#
# IDN_UNDOIFERR test.
# The input name is U+002F ("/"; TR #46 disallowed code point).
# Note that libidnkit cannot undo if an error is caused by IDN_MAP.
#
#             api: decodename
...
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -undoiferr -- '/' > output.txt
