...
echo 'from: A0123' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: a0123' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=localset  -decode-regist -undoiferr -- 'A0123' > output.txt
