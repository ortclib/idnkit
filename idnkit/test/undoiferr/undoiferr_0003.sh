...
#
# IDN_UNDOIFERR test.
# The input name is U+E01F0 (unassigned code point) + U+0041 ("A").
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map
#            from: \u{e01f0}A
#         actions: IDN_ENCODE_REGIST IDN_LOCALCONV IDN_UNDOIFERR
#          result: success
#              to: \u{e01f0}a
...
echo 'from: \u{e01f0}A' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{e01f0}a' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -encode-regist -localconv -undoiferr -- '\u{e01f0}A' > output.txt
