...
#            conf: map
#            from: \u{e01f0}A
#         actions: IDN_DECODE_REGIST IDN_LOCALCONV IDN_UNDOIFERR
#          result: success
#              to: \u{e01f0}a
...
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -localconv -undoiferr -- '\u{e01f0}A' > output.txt
