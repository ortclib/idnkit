...
#
# IDN_UNDOIFERR test.
# The input name is U+05D0 (Bidiclass=R) + U+0041 ("A"; Bidiclass=L).
#
#             api: decodename
...
echo 'to: \u{5d0}a' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -localconv -undoiferr -- '\u{5d0}A' > output.txt
