...
#
# IDN_UNDOIFERR test.
# The input name is U+00B7 (CONTEXTO code point) + U0041 ("A").
#
#             api: decodename
...
echo 'from: \u{b7}A' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{b7}a' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -localconv -undoiferr -- '\u{b7}A' > output.txt
