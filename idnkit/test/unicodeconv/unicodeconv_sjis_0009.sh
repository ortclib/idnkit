...
# The input name is an incomplete Shift_JIS string.
#
#             api: decodename
...
#          result: no mapping to output codeset
#              to: 
...
echo 'result: no mapping to output codeset' >> expect.txt
echo 'to: ' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -- '‚' > output.txt
