...
# The input name is Punycode U+00E0 U+00E1 U+00E2 U+00E3 U+00E4.
#
#             api: encodename
...
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -idnconv -- 'àáâãä' > output.txt
