...
# The input name is an A-label with full-width characters.
#
#             api: decodename
#  local_encoding: U-escape
#            conf: map width
#            from: \u{ff38}\u{ff2e}\u{ff0d}\u{ff0d}\u{ff4c}\u{ff18}\u{ff4a}
...
echo 'from: \u{ff38}\u{ff2e}\u{ff0d}\u{ff0d}\u{ff4c}\u{ff18}\u{ff4a}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: \u{3042}' >> expect.txt
../common/test_decodename -conffile=idn2.conf -localcheckfile=  -decode-regist -- '\u{ff38}\u{ff2e}\u{ff0d}\u{ff0d}\u{ff4c}\u{ff18}\u{ff4a}' > output.txt
