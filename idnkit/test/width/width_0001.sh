...
# The input name is full-width 'A' + 'B' + 'C' + 'D' + 'E'.
#
#             api: encodename
#  local_encoding: U-escape
#            conf: map width
#            from: \u{ff21}\u{ff22}\u{ff23}\u{ff24}\u{ff25}
...
echo 'from: \u{ff21}\u{ff22}\u{ff23}\u{ff24}\u{ff25}' >> expect.txt
echo 'result: success' >> expect.txt
echo 'to: ABCDE' >> expect.txt
../common/test_encodename -conffile=idn2.conf -localcheckfile=  -unicodeconv -map -localconv -- '\u{ff21}\u{ff22}\u{ff23}\u{ff24}\u{ff25}' > output.txt
